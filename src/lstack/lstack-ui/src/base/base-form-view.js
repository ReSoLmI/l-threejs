...
export default {
  ...
  data() {
    return {
      ...
      route: undefined,
      requiredInputRule: [{ required: true, trigger: 'blur', message: '输入不能为空' }],
      requiredSelectRule: [{ required: true, trigger: 'change', message: '请选择' }],
      requiredDefaultRule: [{ required: true, trigger: 'change', message: '数据不能为空' }],
    }
  },
  computed: {
    cRoute() {
