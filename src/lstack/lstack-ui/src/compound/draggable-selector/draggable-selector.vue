          ...
          <header-layout top-class="draggable-selector__panel-header">
            <template #topLeft>
              <slot name="leftTitle">
                ...
                <lui-tip-icon v-if="leftTitleTip" size="xs" icon="question" margin-left :tip="leftTitleTip" />
              </slot>
            </template>
            ...
            <template #topRight>
              ...
              >
                <lui-button
                  ...
                  :icon="loading ? 'lui-icon-loading' : 'lui-icon-refresh'"
            ...
            >
              <transition-group type="transition" :name="'flip-list'" class="draggable-selector__option-list" tag="ul">
                <li
                  ...
                  :key="
                    unselectedOption
                      ? unselectedOption[cSelectValueKey ? cSelectValueKey : cValueUpdateKey]
                      : `unselected-option-${index}`
                  "
        ...
        <div class="draggable-selector__cell draggable-selector__panel">
          <header-layout top-class="draggable-selector__panel-header">
            <template #topLeft>
              ...
              <lui-tip-icon v-if="rightTitleTip" size="xs" icon="question" margin-left :tip="rightTitleTip" />
            </template>
          </header-layout>
          <div class="draggable-selector__panel-body">
            <draggable
            ...
            >
              <transition-group name="no" class="draggable-selector__option-list" tag="ul">
                <li
                  v-for="(selectedOption, index) in cValue"
                  :key="
                    selectedOption
                      ? selectedOption[cSelectValueKey ? cSelectValueKey : cValueUpdateKey]
