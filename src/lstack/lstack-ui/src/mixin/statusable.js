...
const status2typeItemMap = {
  ...
  Succeeded: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '成功'),
  Normal: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '正常'),
  Abnormal: getTypeItemMethod(WARNING, WARNNING_ICON, '异常'),
  Error: getTypeItemMethod(ERROR, ERROR_ICON, '失败'),
  Ready: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '正常'),
  ...
  UnInstalled: getTypeItemMethod(WARNING, WARNNING_ICON, '未安装'),
  UnInstall: getTypeItemMethod(WARNING, WARNNING_ICON, '未安装'),
  Installing: getTypeItemMethod(PRIMARY, LOADING_ICON, '正在安装'),
  InstallFailed: getTypeItemMethod(ERROR, ERROR_ICON, '安装失败'),
  InstallFailure: getTypeItemMethod(ERROR, ERROR_ICON, '安装失败'),
  Uninstalling: getTypeItemMethod(PRIMARY, LOADING_ICON, '正在卸载'),
  UnInstalling: getTypeItemMethod(PRIMARY, LOADING_ICON, '正在卸载'),
  UnInstallFailed: getTypeItemMethod(ERROR, ERROR_ICON, '卸载失败'),
  UninstallFailed: getTypeItemMethod(ERROR, ERROR_ICON, '卸载失败'),
  ...
  Cancelled: getTypeItemMethod(TIP, DISABLE_ICON, '已取消'),
  ...
  Waiting: getTypeItemMethod(TIP, WAITING_ICON, '等待启动'),
  ...
  Paused: getTypeItemMethod(TIP, STOP_ICON, '暂停'),
  ...
  Timeout: getTypeItemMethod(ERROR, ERROR_ICON, '超时'),
  ConditionCheckFailed: getTypeItemMethod(ERROR, ERROR_ICON, '条件判断失败'),
  Scheduled: getTypeItemMethod(WARNING, WARNNING_ICON, '扫描异常'),
  Bound: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '已绑定'),
  UnApproval: getTypeItemMethod(TIP, RUNNING_ICON, '未审批'),
  Approved: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '审批通过'),
  Rejected: getTypeItemMethod(ERROR, DISABLE_ICON, '已驳回'),
  Passed: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '通过'),
  EnvApplying: getTypeItemMethod(PRIMARY, LOADING_ICON, '申请审批中'),
  EnvDeleting: getTypeItemMethod(ERROR, LOADING_ICON, '删除审批中'),
  EnvRejected: getTypeItemMethod(ERROR, DISABLE_ICON, '已驳回'),
  EnvAvailable: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '可用'),
  EnvUpdating: getTypeItemMethod(PRIMARY, LOADING_ICON, '更新审批中'),
  EnvError: getTypeItemMethod(ERROR, ERROR_ICON, '异常'),
  Initializing: getTypeItemMethod(PRIMARY, LOADING_ICON, '正在初始化'),
  Applied: getTypeItemMethod(SUCCESS, SUCCESS_ICON, '已申请'),
  Unapply: getTypeItemMethod(TIP, RUNNING_ICON, '未申请'),
  Undetected: getTypeItemMethod(TIP, RUNNING_ICON, '未检测'),
  DetectSucceed: getTypeItemMethod(SUCCESS, RUNNING_ICON, '检测通过'),
  DetectFailed: getTypeItemMethod(ERROR, ERROR_ICON, '检测未通过'),
}
  ...
  computed: {
    cStatus() {
      if (typeof this.status === 'string') {
        const statusFirst = this.status.slice(0, 1)
        return statusFirst.toUpperCase() + this.status.slice(1)
      }
      return this.status
    },
    cType() {
