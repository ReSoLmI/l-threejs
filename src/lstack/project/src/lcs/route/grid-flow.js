...
export const FlowVirtualService = route(
  'FlowVirtualService',
  'FlowVirtualService',
  'flow-virtual-service',
  {},
  GridFlow
)
export const FlowDestinationRule = route(
  'FlowDestinationRule',
  'FlowDestinationRule',
  'flow-destination-rule',
  {},
  GridFlow
)
...
export const FlowPeerAuthentication = route(
  'FlowPeerAuthentication',
  'FlowPeerAuthentication',
  'flow-peer-authentication',
  {},
  GridFlow
)
export const FlowRequestAuthentication = route(
  'FlowRequestAuthentication',
  'FlowRequestAuthentication',
  'flow-request-authentication',
  {},
  GridFlow
)
export const FlowAuthorizationPolicy = route(
  'FlowAuthorizationPolicy',
  'FlowAuthorizationPolicy',
  'flow-authorization-policy',
  {},
  GridFlow
)
